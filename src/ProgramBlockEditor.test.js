...
const defaultProgramBlockEditorProps = {
    ...
    programSequence: new ProgramSequence([{block: 'forward'}, {block: 'left45'}, {block: 'forward'}, {block: 'left45'}], 0, 0, new Map()),
...
describe("Add nodes", () => {
    test("All aria labels for add buttons should be correct when no action is selected.", () => {
        ...
        const { wrapper } = createMountProgramBlockEditor({
            programSequence: new ProgramSequence([{block: 'forward'}, {block: 'right45'}], 0, 0, new Map()),
            addNodeExpandedMode: true
        });
...
describe("Add program steps", () => {
    test('When the add node at the end of the program is clicked, then the onInsertSelectedActionIntoProgram callback should be called', () => {
        ...
        const { wrapper, mockInsertSelectedActionIntoProgramHandler } = createMountProgramBlockEditor({
            programSequence: new ProgramSequence([{block: 'forward'}, {block: 'forward'}, {block: 'forward'}, {block: 'forward'}, {block: 'forward'}], 0, 0, new Map()),
            selectedAction: 'left45'
        });
...
describe('Replace program steps', () => {
    test.each([
        [ 0, [{block: 'right45'}, {block: 'left45'}, {block: 'forward'}, {block: 'left45'}], 'right45'],
        [ 0, [{block: 'forward'}, {block: 'left45'}, {block: 'forward'}, {block: 'left45'}], null]
...
describe('Move to previous program step', () => {
    test.each([
        [ 0, [{block: 'forward'}, {block: 'left45'}, {block: 'forward'}, {block: 'left45'}]],
        [ 2, [{block: 'forward'}, {block: 'forward'}, {block: 'left45'}, {block: 'left45'}]]
...
describe('Move to next program step', () => {
    test.each([
        [ 0, [{block: 'left45'}, {block: 'forward'}, {block: 'forward'}, {block: 'left45'}]],
        [ 3, [{block: 'forward'}, {block: 'left45'}, {block: 'forward'}, {block: 'left45'}]]
...
describe('Autoscroll to show a step after the active program step', () => {
    ...
    test('When a step after active program block is outside of the container, on the right', () => {
        ...
        wrapper.setProps({
            ...
            programSequence: new ProgramSequence([{block: 'forward'}, {block: 'left45'}, {block: 'forward'}, {block: 'left45'}], 2, 0, new Map())
        });
    ...
    test('When active program block is the last program block, autoscroll to the last add node', () => {
        ...
        wrapper.setProps({
            runningState: 'running',
            programSequence: new ProgramSequence([{block: 'forward'}, {block: 'left45'}, {block: 'forward'}, {block: 'left45'}], 3, 0, new Map())
        });
...
test('focusCommandBlockAfterUpdate', () => {
    ...
    const { wrapper, programBlockEditorRef } = createMountProgramBlockEditor({
        programSequence: new ProgramSequence([{block: 'forward'}, {block: 'forward2'}], 0, 0, new Map())
    });
    ...
    wrapper.setProps({ programSequence: new ProgramSequence([{block: 'forward'}, {block: 'forward3'}, {block: 'forward2'}], 0, 0, new Map()) });
...
test('focusAddNodeAfterUpdate', () => {
    ...
    // And the program is updated
    wrapper.setProps({ programSequence: new ProgramSequence([{block: 'forward'}], 0, 0, new Map()) });
...
test('scrollToAddNodeAfterUpdate', () => {
    ...
    // And the program is updated
    wrapper.setProps({ programSequence: new ProgramSequence([{block: 'forward'}, {block: 'forward'}, {block: 'forward'}, {block: 'forward'}, {block: 'forward'}, {block: 'left45'}], 0, 0, new Map()) });
